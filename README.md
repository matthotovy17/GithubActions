[![Run App Matt Hotovy](https://github.com/matthotovy17/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/matthotovy17/GithubActions/actions/workflows/run-app.yaml)
